...
class GrofastverificationActivity4 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_grofastverification4)
        ...
        nextButton.setOnClickListener {
            val otp = otp1.text.toString() +
                    ...
                    if (otp.length == 4) {
                        ...
                        val intent =Intent(this,GrofastelectlocationActivity4::class.java)
